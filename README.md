...
- Integration with Metrology Applications (How the user can do the inference for fresh data)
- Use synthetic data to train or augment a defect detection model.
- Please provide dependencies such as (requirements.txt,... ) for your project 
## Submission
...
4. Set the privacy level to "Public", then click the "Begin Import" button at the bottom of the page.
